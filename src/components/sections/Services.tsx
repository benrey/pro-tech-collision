            ...
            {services.map((service, index) => {
              ...
              return (
                <Reveal as="li" key={service.slug} delay={index * 70}>
                  <div className="spot-card h-full rounded-2xl border border-border-subtle bg-surface-raised p-6 hover:border-border-strong">
                    <span className="icon-chip grid h-11 w-11 place-items-center rounded-xl bg-primary/10 text-primary">
